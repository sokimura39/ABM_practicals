...
; calculate where humans can 'see' chickens
to humans-look
  ask patches [set pcolor black]

  ask humans[
    let my-visible-patches patches-i-can-see
    ask my-visible-patches [set pcolor red]
  ]

end

; report patches humans can see
...
to humans-move
  ...
  [
    ...
    ; face chicken if within vision
    ifelse any? chickens-on my-visible-patches
    [face one-of chickens-on my-visible-patches]
